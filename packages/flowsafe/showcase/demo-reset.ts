...
import type { TenantResolver } from '../src/approval-api/index.js';
import { TenantResolutionError } from '../src/approval-api/index.js';
import type { PurgeTenantResult } from '../src/do-runner/index.js';
...
export interface DemoResetRouterOptions {
  ...
  /** The purge seam — D1 purgeTenant in the worker, in-memory in app:dev. */

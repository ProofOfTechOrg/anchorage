...
| `CHANGELOG.md` | Release notes (0.2.0 released 2026-07-11; breakwater is an optional peer consumed only by `./host-kit/module` — its `^0.x` peer range trips changesets' major escalation on every breakwater minor, see root CLAUDE.md "Branching and releases") | Cutting a release |

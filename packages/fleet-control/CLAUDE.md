...
- `cloudflare-client-config.ts`, `cloudflare-worker-attachment-scan.ts`: shared SDK retry bounds and the request-bounded account-wide D1/R2 attachment scanner

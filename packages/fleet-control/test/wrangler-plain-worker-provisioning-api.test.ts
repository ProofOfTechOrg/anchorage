...
// The local binding is `subject` rather than `api` because this file declares
// a module-level `api(runner, options)` helper that the original name would
// shadow inside the block.

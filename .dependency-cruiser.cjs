...
module.exports = {
  forbidden: [
    ...
    },
    {
      ...
      to: {
        path: '(?:^packages/fleet-control/src/(?:cloudflare-fleet-inventory|cloudflare-worker-attachment-scan|cloudflare-client|cloudflare-ordinary-worker-operations|cloudflare-provider-errors|cloudflare-rate-coordinator|workers-for-platforms-backend-switch-provider|workers-for-platforms-backend|plain-worker-backend|wrangler-plain-worker-provisioning-api|wrangler-loop-backend|wrangler-runner|export-file-name|export-store|r2-export-store|index)\\.ts$|^packages/fleet-control/src/workers/)',
        reachable: true,
      },
    },
    {

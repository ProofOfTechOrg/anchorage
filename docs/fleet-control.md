...
- Item page limits from 1 through 1,000, the page ceiling a conforming operation store serves: a larger `limit` returns the 1,000-row page rather than a refusal, and the cursor carries the rest. Explicit prune limits from 1 through 1,000, refused outside that range

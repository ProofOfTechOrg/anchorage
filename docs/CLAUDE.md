...
| `security-threat-model.md` | Assets, seven trust boundaries (incl. tenant↔tenant: INV-1/2/3 and the residuals they do not cover), threats (incl. content-inspection + notification-exposure rows), RBAC model, audit log schema | Security review, threat modeling, RBAC design |
